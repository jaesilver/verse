...
app.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog){
  ...
  $scope.activity = [
      {
        what: 'What is income tax?',
        who: 'Ali Conners',
        avatar: 'svg-1',
        when: '9:12PM',
        notes: " I am new reacent employee at a leading MNC , I have to file my taxes tomorrow . How can know about taxes "
      },
      {
        what: 'Should I pay tax?',
        who: 'to Alex, Scott, Jennifer',
        avatar: 'svg-2',
        when: '8:52AM',
        notes: "Do we have to file income tax even if the taxable income is zero?"
      },
      {
        what: 'Tax return',
        who: 'Sandra Adams',
        avatar: 'svg-3',
        when: '10:35AM',
        notes: "My empoloyer deducts and deposits TDS on my behalf ,Do I need to still file my tax return ?"
      },
      {
        what: 'TDS on income tax',
        who: 'Trevor Hansen',
        avatar: 'svg-4',
        when: '1:08PM',
        notes: "Why do I have to pay tax even when TDS was deducted from my income? "
      },
      {
        what: 'Tax deduction',
        who: 'Brian Holt',
        avatar: 'svg-5',
        when: '3:28PM',
        notes: "What’s the difference between a tax credit and a tax deduction"
      },
    ];
